...
siempre del mismo estado: un admin, la caja por defecto, un producto con
stock y un cliente. Solo corre con DEBUG=True o E2E_SEED_ALLOWED=True: borra
un esquema completo y nunca debe ejecutarse contra produccion.
