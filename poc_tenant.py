...
from core.models import Tenant, Domain  # noqa: E402


def create_tenants():
    print("Creando tenant public...")
    # Crear el tenant publico
    tenant = Tenant(schema_name="public", company_name="Servicio Publico")
    tenant.save()
    ...
    tenant1 = Tenant(schema_name="tenant1", company_name="Empresa de Prueba 1")
