    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "refund_type",
                    models.CharField(
                        choices=[("BALANCE", "BALANCE"), ("CASH", "CASH")],
                        max_length=10,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["updated_at"], name="promotions_updated_92a863_idx"
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="customer",
            index=models.Index(
                fields=["updated_at"], name="customers_updated_a69b42_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customer",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["search_vector"], name="customers_search__eb6e2d_gin"
            ),
        ),
        migrations.AddConstraint(
            model_name="customer",
